...
public class Main {
    ...
    public static void main(String[] args) throws IOException, CloneNotSupportedException {
        ...
        for(Student i: studentList){
            i.setAverage();
            System.out.println(i.getFullName()+" has "+i.getTestCount()+" with average of "+i.getAverage());
        }

        Student studentCopy;        //making a new object of type student to hold copy values
        studentCopy = new Student();
        ArrayList<Student> studentCopyList = new ArrayList<>();  //new array list to hold all the copies
